...
async function doSpin(options = {}) {
    ...
    if (totalWinUSD > 0) {
        ...
        const linesText = lineWins
            ...
            .concat(bonusWinUSD ? [`BONUS × ${bonusResult.count} → ${fmtUSD(bonusWinUSD)}`] : [])
